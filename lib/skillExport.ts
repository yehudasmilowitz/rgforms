...
\`\`\`json
{
  "data": {
    ...
    "hero_subtitle":  "Built with Sheetspin",
...
export function generateSkillExport(opts: SkillExportOptions): string {
  ...
  const header = format === 'claude'
    ? `# Sheetspin — AI Skill File

This file teaches Claude Code how to integrate with all of this project's Sheetspin modules.
Include it as \`CLAUDE.md\` at the root of your project, or import it in your CLAUDE.md.

Generated by [Sheetspin](https://sheetspin.com) · ${new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}

---`
    : format === 'cursor'
    ? `# Sheetspin — Cursor Rules

This file teaches Cursor AI how to integrate with all of this project's Sheetspin modules.
Include it as \`.cursorrules\` at the root of your project.

Generated by Sheetspin · ${new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}

---`
    : `# Sheetspin — Integration Reference

This file documents all Sheetspin modules for this project and provides ready-to-use code snippets.
...
This project uses **Sheetspin** — a serverless Google Drive backend.
