  ...
  return (
    <article className="w-full max-w-2xl mx-auto flex flex-col gap-10 pb-20 pt-4">
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="rounded-xl p-5"
          ...
          <p className="text-base font-semibold leading-snug" style={{ color: 'var(--color-text)', fontFamily: 'var(--font-display)' }}>
            rgforms is not a website builder. It&apos;s an instant typed REST API backed by a Google Sheet,
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="rounded-xl overflow-hidden" style={{ border: '1px solid var(--color-border)' }}>
          ...
          {[
            ...
            { name: 'rgforms (this)', price: '$19–49/mo', typed: '✓ auto-generated', gap: '—' },
          ].map(({ name, price, typed, gap }, i) => {
            const isUs = name.startsWith('rgforms');
            return (
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="text-sm leading-relaxed" style={{ color: 'var(--color-muted)' }}>
          User connects their Google account, names a project. rgforms provisions a Sheet + Script in their
...
rgforms provisions:
  ...
  → Gateway entry: api.rgforms.app/v1/acme-crm → script URL + API key
...
All endpoints:
  → Require API key (x-rgforms-key header)
...
Response shape:
  {
    ...
    meta: { total, limit, offset, schema: { name: "string", email: "string", ... } }
      ...
      <section className="flex flex-col gap-4">
        ...
        <Code>{`// Auto-generated client — published to npm as @rgforms/client-acme-crm
// Regenerates whenever a column is added/removed in the Sheet

import { createClient } from '@rgforms/client-acme-crm'
...
// the generated types include phone: string on the next client regeneration`}
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="text-sm leading-relaxed" style={{ color: 'var(--color-muted)' }}>
          ...
          <code className="text-xs px-1 rounded font-mono mx-1" style={{ background: 'var(--color-surface-2)', color: 'var(--color-text)' }}>api.rgforms.app</code>
          URL. The gateway is what turns the user&apos;s Script URL (ugly, exposable) into a managed API endpoint.
        </p>
        <Code>{`Request path:

  Developer → GET api.rgforms.app/v1/acme-crm/contacts?filter[status]=active
  ...
  Worker:
    ...
    3. Validate x-rgforms-key header against stored apiKey → 401 if missing
  ...
  Security:
    ...
    → Direct hits to the Script URL can be blocked via X-RGForms-Token
    ...
    Total:                    ~$6/mo for 1,000 active projects`}
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="rounded-xl p-4 flex flex-col gap-3"
            ...
            <div>
              <p className="text-sm font-bold" style={{ color: cyan }}>rgforms API</p>
          ...
          <div className="rounded-xl p-4 flex flex-col gap-3"
            ...
            <div>
              <p className="text-sm font-bold" style={{ color: amber }}>rgforms Forms</p>
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="text-sm leading-relaxed" style={{ color: 'var(--color-muted)' }}>
          ...
          reference implementation that demonstrates what you can build with the rgforms API in ~200 lines
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex flex-col gap-2">
            ...
            <Cross items={[
              ...
              'Preview renderer page in rgforms app',
  ...
  npm package: @rgforms/client-my-project (auto-generated)`}
              </Code>
            </div>
          }
        />
...
Validation:
  ...
  → No X-RGForms-Token header → 403 (blocks direct script access)`}
              </Code>
            </div>
          }
        />
        ...
        <Step n="3" label="Cloudflare Workers gateway" effort="3–4 days" color={cyan} colorA={cyanA}
          detail={
            <div className="flex flex-col gap-2">
              ...
              <Code>{`api.rgforms.app/v1/{slug}/{tab}
  → Worker → KV lookup for slug → scriptUrl + apiKey
  → Validate x-rgforms-key
  → Rate limit (Cloudflare native, no extra cost)
  → Forward to Script with X-RGForms-Token
        ...
        <Step n="5" label="Auto-generated TypeScript client" effort="3–4 days" color={cyan} colorA={cyanA}
          detail={
            <div className="flex flex-col gap-2">
              ...
              <Code>{`Package: @rgforms/client-{slug}
Published to: npm (public, no auth needed to install)
Regeneration trigger: onEdit in Apps Script → POST /api/regenerate-client

Usage:
  npm install @rgforms/client-my-project

  import { createClient } from '@rgforms/client-my-project'
  const db = createClient({ key: process.env.RGFORMS_KEY })
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="rounded-xl overflow-hidden" style={{ border: '1px solid var(--color-border)' }}>
              {[
                ...
                ['Build renderer', '~200 lines of Next.js consuming the rgforms API. Deploy to Vercel.'],
                ['Connect domain', 'His domain → Vercel. Done. No custom domain feature needed in rgforms.'],
