      ...
      <div className="w-full max-w-lg flex flex-col gap-8">
        ...
        {loading ? (
          <div className="flex items-center gap-3 py-8 justify-center">
            <SpinnerIcon />
            <p className="text-sm" style={{ color: 'var(--color-muted)' }}>Loading your projects…</p>
          </div>
        ) : sites.length > 0 ? (
          ...
          <div className="flex flex-col items-center gap-2 py-10 text-center">
            <p className="text-sm font-medium" style={{ color: 'var(--color-text)' }}>No projects yet</p>
        ...
        {!showNewForm ? (
          ...
          >
            ...
            <input
              ...
              placeholder="e.g. Acme Corp — name for this project"
              autoFocus
