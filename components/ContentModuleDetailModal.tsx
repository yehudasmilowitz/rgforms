    ...
    >
      ...
      >
        ...
        <div className="overflow-y-auto flex flex-col gap-6 p-6">
          {/* Endpoint + auth — shown whenever deploymentUrl exists */}
          ...
          {!hasDetails ? (
            <p className="text-sm" style={{ color: 'var(--color-muted)' }}>
              Integration code is not available for this module. It may have been created before field data was stored.
            </p>
          ) : (
            <>
              {/* Code snippets — only when fields are available */}
