    ...
    >
      <div className="w-full max-w-2xl flex flex-col gap-8 animate-slide-up">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          >
            <svg className="w-3.5 h-3.5 shrink-0" viewBox="0 0 14 14" fill="none" aria-hidden="true">
              <path d="M2 7.5l3.5 3.5 6.5-6.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            Your form is ready!
          </div>
        ...
        <div
          ...
          style={{ background: 'rgba(234,179,8,0.07)', borderColor: 'rgba(234,179,8,0.35)' }}
        >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            {[
              { href: result.sheetUrl, label: 'Open my Google Sheet' },
              { href: result.scriptUrl, label: 'View Apps Script' },
            ].map(({ href, label }) => (
              <a
                key={label}
                href={href}
